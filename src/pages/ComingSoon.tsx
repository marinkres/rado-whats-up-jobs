  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="grid md:grid-cols-5 gap-12 md:gap-8 py-10">
          ...
          >
            ...
            <div className="relative z-10 w-full max-w-lg">
              ...
              {/* WhatsApp & Telegram integration badges */}
              <motion.div 
              ...
              >
                ...
                <div className="bg-black/40 backdrop-blur-lg px-4 py-2 rounded-full border border-white/10 shadow-lg flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240" className="h-5 w-5" fill="none">
                    <circle cx="120" cy="120" r="120" fill="#229ED9"/>
                    <path d="M180.6 78.8c2.5-11.9-4.2-16.5-12.1-13.7L54.8 109.1c-11.6 4.5-11.5 11-2 13.6l30.8 9.6 12.1 38.5c1.6 4.5 2.8 6.2 5.7 6.2 2.9 0 4.1-1.1 5.7-4.5l16.7-33.5 34.8 25.7c6.4 4.4 11.1 2.1 12.7-5.9l21.3-97.9z" fill="#fff"/>
                  </svg>
                  <span className="text-white text-sm">Telegram integracija</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
        ...
        <motion.div 
          className="mt-20 py-16 px-4 md:px-8 bg-white/5 backdrop-blur-sm borde</svg>r border-white/10 rounded-2xl"
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3, duration: 0.7 }}
        >
